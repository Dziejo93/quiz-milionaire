...
const resources = {
  en: {
    translation: {
      ...
      eachQuestionHasATimeLimit: 'Each question has a 3-minute time limit',
      ...
      eachQuestionHasTimeLimit: '• Each question has a 3-minute time limit',
  ...
  pl: {
    translation: {
      ...
      eachQuestionHasTimeLimit: '• Każde pytanie ma limit czasu 3 minuty',
